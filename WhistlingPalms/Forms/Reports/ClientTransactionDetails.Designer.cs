namespace WhistlingPalms
{
    partial class ClientTransactionDetails
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ClientTransactionDetailsBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.ReportsDataSet = new WhistlingPalms.ReportsDataSet();
            this.reportViewer1 = new Microsoft.Reporting.WinForms.ReportViewer();
            this.ClientTransactionDetailsTableAdapter = new WhistlingPalms.ReportsDataSetTableAdapters.ClientTransactionDetailsTableAdapter();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.ClientTransactionDetailsBindingSource)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.ReportsDataSet)).BeginInit();
            this.tableLayoutPanel1.SuspendLayout();
            this.panel1.SuspendLayout();
            this.SuspendLayout();
            // 
            // ClientTransactionDetailsBindingSource
            // 
            this.ClientTransactionDetailsBindingSource.DataMember = "ClientTransactionDetails";
            this.ClientTransactionDetailsBindingSource.DataSource = this.ReportsDataSet;
            // 
            // ReportsDataSet
            // 
            ...
            reportDataSource1.Value = this.ClientTransactionDetailsBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "WhistlingPalms.ReportFiles.ClientTransactionDetails.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(3, 123);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.PageCountMode = Microsoft.Reporting.WinForms.PageCountMode.Actual;
            this.reportViewer1.Size = new System.Drawing.Size(771, 312);
            this.reportViewer1.TabIndex = 0;
            this.reportViewer1.ReportRefresh += new System.ComponentModel.CancelEventHandler(this.reportViewer1_ReportRefresh);
            // 
            // ClientTransactionDetailsTableAdapter
            // 
            this.ClientTransactionDetailsTableAdapter.ClearBeforeFill = true;
            // 
            // tableLayoutPanel1
            // 
            ...
            this.tableLayoutPanel1.Size = new System.Drawing.Size(777, 438);
            ...
            this.Text = "Client Transaction Details Report";
            this.Load += new System.EventHandler(this.ClientTransactionDetails_Load);
            ((System.ComponentModel.ISupportInitialize)(this.ClientTransactionDetailsBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource ClientTransactionDetailsBindingSource;
        private ReportsDataSet ReportsDataSet;
        private ReportsDataSetTableAdapters.ClientTransactionDetailsTableAdapter ClientTransactionDetailsTableAdapter;
