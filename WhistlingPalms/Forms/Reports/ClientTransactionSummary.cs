...
{
    public partial class ClientTransactionSummary : Form
    {
        public ClientTransactionSummary()
        {
            InitializeComponent();
        }
        ...
        {
            if (this.ReportsDataSet.TransactionSummary.Rows.Count <= 0 || forceReload)
            {
        ...
        private void ClientTransactionSummary_Load(object sender, EventArgs e)
        {
